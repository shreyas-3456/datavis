  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-5 h-16 border-b border-gray-800 shrink-0">
        ...
        <span className="text-white font-bold text-base tracking-tight">DataVis</span>
      </div>
      ...
      <div className="px-3 py-4 border-t border-gray-800 shrink-0">
        <p className="text-xs text-gray-600 px-3">DataVis Platform v1.0</p>
      </div>
    </aside>
  );
}