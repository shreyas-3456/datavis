...
import { loginAction, ActionState } from "@/lib/actions/auth.actions";
    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-1 text-sm">Sign in to your DataVis account</p>
        </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-xl">
          ...
          {/* Google OAuth */}
            ...
            className="flex items-center justify-center gap-3 w-full border border-gray-700 hover:border-gray-600 bg-gray-800 hover:bg-gray-750 text-white py-2.5 rounded-lg transition-colors duration-200 mb-6"
          >
